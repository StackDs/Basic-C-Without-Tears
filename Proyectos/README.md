...
> 🟢 **Fácil / Principiante**: Ideal para afianzar sintaxis, matrices 2D elementales, bucles y lógica modular básica.  
> 🟡 **Intermedio**: Requiere manejo de máquinas de estados, sincronización temporal, algoritmos de búsqueda o estructuras dinámicas.  
> 🔴 **Avanzado**: Implica grafos dirigidos, optimizaciones espaciales ($\mathcal{O}(N)$), cinemática continua, físicas vectoriales o gestión masiva de entidades concurrentes.
...
- **Proyectos disponibles**:
   - 🟢 [`01_Dashboard_Financiero`](./03_Dashboards_y_Gestion/01_Dashboard_Financiero/): Registro de ingresos y gastos, cálculo de balances, presupuestos y gráficos de tendencias.
